...
<body id="page-top">
    ...
    <div class="wrapper">
        <form action="" method="POST">
            ...
            <h5>Description:</h5>
            <div class="pass-field">
                <textarea name="description" class="text-jqte" placeholder="Description" style="width: 100%; height: 100%;"><?php echo isset($description) ? $description : '' ?></textarea>
            </div>
            <button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right" type="submit" id="submitBtn" name="submit">

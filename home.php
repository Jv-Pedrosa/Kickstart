...
<div id="popup">
    ...
    <a href="index.php?page=home" onclick="toggle()">Close</a>
</div>
...
// WHEN NO LOGIN ACCOUNT!!

window.onscroll = function() {
    var pageHeight = document.documentElement.offsetHeight;
    var windowHeight = window.innerHeight;
    var scrollPosition = window.scrollY || window.pageYOffset || document.body.scrollTop + (document
        .documentElement && document.documentElement.scrollTop || 0);

    if (pageHeight - windowHeight - scrollPosition < 1) {

        document.getElementById("classBlurred").classList.add("blur-effect");
        document.getElementById("classBlurred2").classList.add("blur-effect");
    }
};
$('.card.vacancy-list').click(function() {
    toggle();

        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="admin/jobs.php?page=about">JOBS
                            APPLICATION </a>
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger"  href="profile.php">PROFILE</a>

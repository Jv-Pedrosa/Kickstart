...
if(isset($_POST['login'])){
    ...
    $stmt = $conn->prepare("SELECT * FROM company WHERE email = ? AND password = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['UserFirstName'] = $row['companyName']; // Storing firstname in session
        $_SESSION['UserLastName'] = $row['city'];
...
<body style="overflow: hidden;">
    ...
    <div class="blurry-image">
        <img class="blurry-image" src="img/adminlogin.png" alt="">
    </div>
    ...
    <div id="form-login" class="login-container">
        ...
        <form action="" method="post">
            ...
            <br>
            <a href="companyReg.php"><img class="pic1" src="img/add.png" alt="" style="height: 2rem;">Create Account</a>
            </p>
